   ...
   <div class= "form-wrapper">
    ...
    <v-list>
          ...
          <v-list-item-content  >
            <v-row class="userList">
              ...
              <v-col class="btnitems">
                <v-btn   @click.capture="editUser(i)"  to="/edituser" class="mx-2" fab dark small color="primary"  >
               ...
               <v-col class="btnitems" >
                <v-btn @click="infoUser(i)" class="mx-2" fab dark small color="primary" >
                  <v-icon dark>
                    mdi-eye
                  </v-icon>
                </v-btn>
               ...
               <v-col class="btnitems">
                <v-btn class="mx-2" fab dark small color="primary" @click="deleteUser(i)">
                  <v-icon dark>
                   mdi-delete
                  </v-icon>
                </v-btn>
      ...
      <v-dialog   v-model="dialog"    max-width="360px" >
          <v-card scrollable >
            <v-divider></v-divider>
            <v-card-title>Información de {{selectedUser.name}}</v-card-title>
              <v-divider></v-divider>
              <v-spacer></v-spacer>
              <br>
               <v-card-text >
